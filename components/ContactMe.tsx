...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (FormData) => {
    window.location.href = `mailto:abdelkaderismail82@gmail.com?subject=${FormData.subject}&body=Hi, my name is ${FormData.name}. ${FormData.message}
     (${FormData.email})`;
  };
      ...
      <div className=" flex flex-col space-y-10 mt-24">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">+44777777</p>
          </div>
        </div>
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">116 London road</p>
          </div>
        </div>
